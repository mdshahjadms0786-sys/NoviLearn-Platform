...
export function PracticeSessionDetailView({
  ...
  const stats: Array<{ label: string; value: string }> = [
    ...
    { label: "Correct", value: `${detail.correctAnswers}` },
    { label: "Incorrect", value: `${detail.incorrectAnswers}` },
    { label: "Questions", value: `${detail.totalQuestions}` },
    { label: "Question type", value: `${detail.questionType}` },
  ];
          ...
          <View style={styles.list}>
            {detail.results.map((entry, index) => (
              <View
                ...
                style={[styles.question, { borderColor: theme.colors.outline }]}
              >
