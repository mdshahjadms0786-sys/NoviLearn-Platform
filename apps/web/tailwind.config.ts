import { designTokens } from '@novilearn/design-tokens';
...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        xs: [designTokens.typography.fontSizes.xs, { lineHeight: '1.5' }],
        sm: [designTokens.typography.fontSizes.sm, { lineHeight: '1.5' }],
        base: [designTokens.typography.fontSizes.base, { lineHeight: '1.5' }],
        lg: [designTokens.typography.fontSizes.lg, { lineHeight: '1.5' }],
        xl: [designTokens.typography.fontSizes.xl, { lineHeight: '1.5' }],
        '2xl': [
