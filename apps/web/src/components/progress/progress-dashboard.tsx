...
export function ProgressDashboard() {
  ...
  const [data, setData] = React.useState<ProgressDashboardState>({
    summary: null,
    learningActivities: [],
    practiceSessions: [],
    topics: [],
  ...
  const [selectedSession, setSelectedSession] =
    React.useState<PracticeSessionSummary | null>(null);
  const [detail, setDetail] = React.useState<PracticeSessionDetail | null>(
    null,
  );
  ...
  const openSession = React.useCallback(
    async (session: PracticeSessionSummary): Promise<void> => {
      if (token === null) {
        return;
      }
  ...
  const retryDetail = React.useCallback((): void => {
