...
} from "../src/progress/calculations";
import { buildSuggestions } from "../src/progress/personalization";
...
check(
  ...
  buildSuggestions({
    recentLearning: [{ topic: "math", at: new Date("2026-01-02T00:00:00Z") }],
    recentPractice: [],
    weakTopics: [],
    relatedNextTopics: [],
...
check(
  ...
  buildSuggestions({
    recentLearning: [
      { topic: "algebra", at: new Date("2026-01-02T00:00:00Z") },
      { topic: "geometry", at: new Date("2026-01-03T00:00:00Z") },
    ],
    recentPractice: [],
    weakTopics: [],
    relatedNextTopics: [],
...
check(
  ...
  buildSuggestions({
    recentLearning: [],
    recentPractice: [
      { topic: "chemistry", at: new Date("2026-01-02T00:00:00Z") },
    ],
    weakTopics: [],
    relatedNextTopics: [],
    masteredTopics: new Set(),
...
check(
  ...
  buildSuggestions({
    ...
    weakTopics: [],
    relatedNextTopics: [
      { topic: "calvin cycle", at: new Date("2026-01-02T00:00:00Z") },
    ],
    masteredTopics: new Set(),
  }).map((s) => s.kind),
  ["related_next_topic"],
...
check(
  ...
  buildSuggestions({
    recentLearning: [
      { topic: "english", at: new Date("2026-01-02T00:00:00Z") },
    ],
    recentPractice: [
      { topic: "history", at: new Date("2026-01-02T00:00:00Z") },
    ],
    weakTopics: [
      {
        topic: "music",
    ...
    relatedNextTopics: [{ topic: "art", at: new Date("2026-01-02T00:00:00Z") }],
    masteredTopics: new Set(),
  }).map((s) => s.kind),
  [
    "continue_learning",
